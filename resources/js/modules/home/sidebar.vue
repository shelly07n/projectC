    ...
    <aside class="flex flex-col items-center bg-white text-gray-700 shadow h-full">
        ...
        <div class="h-16 flex items-center w-full">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                class="w-6 h-6 animate__animated  animate__heartBeat flex flex justify-center items-center w-full">
        ...
        <ul>
            ...
            <li class="hover:bg-gray-100">
                <RouterLink :to="`/contests`" class="h-16 px-6 flex flex justify-center items-center w-full
                        focus:text-orange-500" replace>
            ...
            <li class="hover:bg-gray-100">
                <RouterLink :to="`/contact`" class="h-16 px-6 flex  justify-center items-center w-full
                        focus:text-orange-500" replace>
